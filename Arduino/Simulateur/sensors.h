...
#define T_TAKEOFF     15    //Delay before takeoff (sec)
#define T_ENGINE      19.5  //Delay before end of combustion (sec)
#define T_APOGEE      40    //Delay before apogee (sec)
#define T_PARACHUTE   162   //Delay before main parachute deploiment (sec)
#define T_LANDING     245   //Delay before landing (sec)
