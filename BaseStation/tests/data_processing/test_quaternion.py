...
class QuaternionTest(unittest.TestCase):
    ...
    def test_radians_to_quaternion(self):
        ...
        computed_quaternion = Quaternion(round(computed_quaternion.w, 3), round(computed_quaternion.x, 3), round(computed_quaternion.y, 3), round(computed_quaternion.z, 3))

        result = Quaternion(0.707, 0.707, 0, 0)

        self.assertEqual(computed_quaternion, result, "actual: {} | excepted: {}".format(str(computed_quaternion), str(result)))
